...
test('runtime cache versions load the isolated home lifecycle and gift adapter', () => {
  ...
  assert.match(template, /real-block1-adapter\.js\?v=19/);
  assert.match(template, /real-device-adapter\.js\?v=19/);
  assert.match(template, /modules\/home\.js\?v=19/);
  assert.match(template, /modules\/devices\.js\?v=19/);
  assert.match(template, /modules\/admin\.js\?v=19/);
  assert.match(template, /src\/main\.js\?v=19/);
});
