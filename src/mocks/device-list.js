(function registerMockDeviceList(globalScope) {
  ...
  // Safe fixtures make the default local preview useful without exposing real keys or devices.
  const DEFAULT_DEVICES = Object.freeze([
    {
      id: 'mock-device-phone-01',
      name: 'Мой телефон',
      platform: 'phone',
      app: 'Karing',
      status: 'online',
